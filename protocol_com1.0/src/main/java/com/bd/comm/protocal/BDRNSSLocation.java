...
public class BDRNSSLocation implements Parcelable{
    ...
    public void dump(Printer pw, String prefix) {
        ...
        pw.println(prefix + "mAvailable="+mAvailable);
    }
    
    public BDRNSSLocation(){
     ...
     * location fix.
     */
    public BDRNSSLocation(String provider) {
        mProvider = provider;
    }
     ...
     * location.
     */
    public BDRNSSLocation(BDRNSSLocation l) {
        set(l);
    }
     ...
     */
    public float distanceTo(BDRNSSLocation dest) {
     ...
     */
    public float bearingTo(BDRNSSLocation dest) {
        synchronized (mResults) {
            // See if we already have the result
            if (mLatitude != mLat1 || mLongitude != mLon1 ||
                            dest.mLatitude != mLat2 || dest.mLongitude != mLon2) {
    ...
    public static final Parcelable.Creator<BDRNSSLocation> CREATOR =
        new Parcelable.Creator<BDRNSSLocation>() {
        public BDRNSSLocation createFromParcel(Parcel in) {
            ...
            l.mAvailable=in.readInt()!=0;
            return l;
        }

        public BDRNSSLocation[] newArray(int size) {
            return new BDRNSSLocation[size];
        }
    };
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeInt(mAvailable?1:0);
   }
