 ...
 *
 */
public class EditUserEyeActivity extends BottomBaseActivity implements OnClickListener{
	...
	private void initTop(){
		...
		title_name.setText(R.string.editusereye_topic);
	...
	private void saveUserEye(){
		...
		if(angle==null||angle.length()==0){
			ToolsUtils.showTipInfo(this, R.string.editeusereye_angle_error_tip);
			return ;
		}
...
//		startActivity(routeIntent);
	...
	protected int getContentView() {
		return R.layout.editusereye_main;
	}
}
