...
import com.novsky.map.main.BD2LocActivity;
import com.novsky.map.main.ReportActivity;
...
public class OtherFunctionActivity extends BaseActivity implements OnItemClickListener{
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		switch (position) {
		case 0:
			Intent intent=new Intent("com.mapabc.android.activity.BDManagerActivity");
			startActivity(intent);
			break;
		case 1:
			target=new Intent(this,BD2LocActivity.class);
			startActivity(target);
			break;
		case 2:
			target = new Intent(this, ReportActivity.class);
			startActivity(target);
			break;
		case 3:// 地图设置
