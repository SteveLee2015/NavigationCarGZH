...
//		MapAPI.getInstance().setPrewMode(true);
	...
	private void initMapView() {
		...
		ImageButton locationBtn=(ImageButton)findViewById(R.id.ib_btn_location_trace);
	...
	public void setButtonVisible(){
		if(back_car.getVisibility()==View.GONE){
			back_car.startAnimation(ToolsUtils.setShowAnimation(this));
		    back_car.setVisibility(View.VISIBLE);
		}
	}
	public void setButtonGone(){
		if(back_car.getVisibility()==View.VISIBLE){
			back_car.startAnimation(ToolsUtils.setHideAnimation(this));
