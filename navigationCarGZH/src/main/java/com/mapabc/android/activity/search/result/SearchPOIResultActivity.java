 ...
 */
public abstract class SearchPOIResultActivity extends BottomBaseActivity {
	...
	private void initTop(){
		...
		title_name.setText(R.string.common_result);
...
//		lstResult.clearChoices();
	...
	private void listLoadPOI(){
		...
		TextView txtCount = (TextView) findViewById(R.id.home_title_content);
		
		txtCount.setVisibility(View.VISIBLE);
		txtCount.setText(ToolsUtils.getValue(this, R.string.common_total)+poiCount+ToolsUtils.getValue(this, R.string.common_record));
	...
	protected int getContentView() {
		return R.layout.searchpoiresult_main;
	}
}