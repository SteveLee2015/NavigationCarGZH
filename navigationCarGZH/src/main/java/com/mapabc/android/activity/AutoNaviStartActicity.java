...
//		
//		SharedPreferences exitPrefs = this.getSharedPreferences("APP_EXIT_CFG", 0);
//		boolean isExit=exitPrefs.getBoolean("IS_EXIT", true);
//		if(isExit){
//			exitPrefs.edit().putBoolean("IS_EXIT", false).commit();
//			new Handler().postDelayed(new Runnable(){
//				public void run() {
//					context.startActivity(new Intent(Constants.ACTIVITY_START_SPLASH));
//					finish();
//				}}, 50);
//		}else{
//			if(Utils.isServiceRunning(this, "com.novsky.map.main.TimeService")){
//				Intent in = new Intent(Constants.ACTIVITY_NAVISTUDIOACTIVITY);
