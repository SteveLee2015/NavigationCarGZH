 ...
 */
public class GlanceRouteActivity extends BottomBaseActivity {
...
//		txtTopic = (TextView) findViewById(R.id.txtTopic);
		title_name.setText(this.getResources().getStringArray(
				R.array.routemanager_items)[2]);
...
//					  this.m_CenterInfo.cName, this.m_CenterInfo.cAddress, this.m_CenterInfo.cPhone,this.m_CenterInfo.cADCode);
	...
	class GlanceRouteView extends View {
		...
		protected void onDraw(Canvas canvas) {
			...
			//解决全程概览 标题被部分遮挡bug
			canvas.drawBitmap(m_Bitmap, x0, title_name.getHeight()*2.0F-12.0F, m_Paint);
//			canvas.drawBitmap(m_Bitmap, x0, txtTopic.getHeight(), m_Paint);
		}
	}

	@Override
	protected int getContentView() {
		return R.layout.glanceroutelayout;
	}
}
