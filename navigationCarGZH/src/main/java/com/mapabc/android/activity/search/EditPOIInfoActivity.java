 ...
 *
 */
public class EditPOIInfoActivity  extends BottomBaseActivity implements OnClickListener {
	...
	private void initTop(){
		...
		title_name.setText(this.getResources().getString(R.string.editpoiinfo_topic));
	...
	protected int getContentView() {
		return R.layout.editpoiinfo_main;
	}
}
