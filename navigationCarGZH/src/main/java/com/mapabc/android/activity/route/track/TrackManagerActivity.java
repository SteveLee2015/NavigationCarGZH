 ...
 *
 */
public class TrackManagerActivity extends BottomBaseActivity implements
		OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		trackManagerNameArr = getResources().getStringArray(R.array.trackmanager_items);
	...
	private void initTop() {
		...
		title_name.setText(R.string.trackmanager_title);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		case 2:// 开始记录轨迹
			...
			{
				ToolsUtils.showTipInfo(this, "当前无GPS信号，不能录制轨迹!");
			}
			break;
		case 3:
			displayTrackSetting();
	...
	protected int getContentView() {
		return R.layout.otherfunction_main;
	}
}
