 ...
 *
 */
public class CrossingViewActivity extends BottomBaseActivity{
	...
	class CrossingView extends View
	{
		...
		protected void onDraw(Canvas canvas)
		{
			...
			canvas.drawBitmap(m_CrossingBitmap, x0,title_name.getHeight()*2.0F-12.0F, m_CrossingPaint);
//			canvas.drawBitmap(m_CrossingBitmap, x0,txtTopic.getHeight(), m_CrossingPaint);
		}
	}
	...
	protected void onCreate(Bundle bundle)
	{
		...
		title_name.setText(R.string.crosing_title);
		//ImageView back = (ImageView) findViewById(R.id.home_title_flag_img);
