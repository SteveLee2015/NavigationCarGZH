...
public class SearchLocListAdapter extends BaseAdapter {
	...
	private String[] searchlocitems_desc;
	...
	public SearchLocListAdapter(Context context){
		...
		searchlocitems_desc = context.getResources().getStringArray(R.array.searchlocitems_desc);
	}
	@Override
	public int getCount() {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		try{
			...
			TextView categoryDescTextView = (TextView) convertView.findViewById(R.id.tv_category_desc);
			categoryDescTextView.setText(searchlocitems_desc[position]);
		}catch(Exception e){
		}
