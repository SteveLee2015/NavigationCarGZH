 ...
 */
public class BDInfoView extends View implements ReceiveInfo {
	private static final String TAG = "BDInfoView";
	private static final int UPDATEGPSINFO = 106;// 更新北斗信息
...
//	public static float mBitmapAdjustment;
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case UPDATEGPSINFO:
				...
				BDInfoView.this.getGPSDesc();
				BDInfoView.this.invalidate();
				break;
			default:
				break;
			}
	...
	public BDInfoView(Context context, AttributeSet att) {
		super(context, att);
...
//		DisPatchInfo.getInstance().addGpsInfoListener("BDInfoView", this);
	}
	...
	private void drawForMdpi(Canvas canvas) {
		if (screenHeight > screenWidth) {// 竖向
			...
			canvas.drawText(context.getString(R.string.gpsinfo_time) + time_str, width,
					height,textpaint);
			// ////////画卫星颗数/////////////
			height = height + 20;
			canvas.drawText(context.getString(R.string.gpsinfo_count)
