 ...
 *
 */
public class MyFavoritesActivity extends BottomBaseActivity {
...
//    private FavoritePageResults pageResults;
    ...
    private void putInData(FavoritePageResults pageResults){
		...
		for (FavoriteInfo data: pageResults.Favorites) {
			...
			ToolsUtils.getClsRearchResultInfo(data, poi);
			String district = ToolsUtils.getDistrictByAdCode(poi, MyFavoritesActivity.this);
...
//	}
	...
	private void initTop(){
		...
		if(searchType==4){
			title_name.setText(this.getResources().getStringArray(R.array.searchlocitems)[4]);
		}else if(searchType==5){
			title_name.setText(this.getResources().getStringArray(R.array.searchlocitems)[5]);
		}
	...
	protected int getContentView() {
		return R.layout.myfavorites_main;
	}
}
