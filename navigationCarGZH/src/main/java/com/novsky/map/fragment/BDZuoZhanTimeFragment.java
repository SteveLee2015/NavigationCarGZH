 ...
 * @author steve  
 */
public class BDZuoZhanTimeFragment extends Fragment {
	/**
	 * 上下文对象
	 */
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		contentView = View.inflate(mContext, R.layout.activity_bd_zuozhan_time, null);
		initUI(contentView);
		return contentView;
	}
    ...
    private void initUI(View contentView){
    	...
    	mYearTx = (TextView) contentView.findViewById(R.id.zuozhan_time_year_tx);
		mMonthTx = (TextView) contentView.findViewById(R.id.zuozhan_time_month_tx);
		mDayTx = (TextView) contentView.findViewById(R.id.zuozhan_time_day_tx);
		mHourTx = (TextView) contentView.findViewById(R.id.zuozhan_time_hour_tx);
		mMinuteTx = (TextView) contentView.findViewById(R.id.zuozhan_time_minute_tx);
		mSecondTx = (TextView) contentView.findViewById(R.id.zuozhan_time_second_tx);
		mStepTx=(TextView) contentView.findViewById(R.id.zuozhan_time_step_tx);
