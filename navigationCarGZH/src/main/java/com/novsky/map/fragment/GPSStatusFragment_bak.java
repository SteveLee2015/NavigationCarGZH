 ...
 * @author steve
 */
public class GPSStatusFragment_bak extends Fragment {
	
    private String TAG="GPSStatusFragment";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if("AOSP on wing".equals(Utils.DEVICE_MODEL)){
			contentView = View.inflate(mContext, R.layout.fragment_gpsstatus_car_7, null);
			dwR=90;
			iCenterX=200;
			iCenterY=110;
			//7寸屏
...
//			iCenterY=180;
			...
			contentView = View.inflate(mContext, R.layout.activity_gpsstatus, null);
		}
	...
	private void initView(View contentView) {
		...
		locationStatus=(TextView)contentView.findViewById(R.id.gps_location_status);
