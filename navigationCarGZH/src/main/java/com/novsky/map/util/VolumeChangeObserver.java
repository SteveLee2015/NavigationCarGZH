...
public class VolumeChangeObserver {
    ...
    public VolumeChangeObserver(Context context) {
        ...
        defaultVolume = getCurrentMusicVolume();
    }
    ...
    public void setMusicVolume(int volume) {
        if (mAudioManager != null) {
            if (defaultVolume > volume) {
                mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC , volume ,AudioManager.ADJUST_LOWER);
            } else {
                mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC , volume ,AudioManager.ADJUST_RAISE);
            }
