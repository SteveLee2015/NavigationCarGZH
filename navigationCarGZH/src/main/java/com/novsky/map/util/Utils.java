...
public class Utils {
    ...
    public static String LOCATION_LONDIR = "";
    public static String LOCATION_LATDIR = "";
...
//		}
    ...
    public static BDLocationReportImp addGPSLocationToAlarm(int fequency, String mUserAddress) {
        ...
        report.setLongitudeDir(LOCATION_LONDIR);
        report.setLatitude(LOCATION_REPORT_LAT);
        report.setLatitudeDir(LOCATION_LATDIR);
        report.setMsgType(1);
