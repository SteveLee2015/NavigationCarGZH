 ...
 * @author steve
 */
public class ManagerInfoActivity extends Activity implements OnClickListener {
	 ...
	 * 设置管信图标
	 */
	private ImageView setManagerInfo = null;

	/**
	 * 读取管理信息图标
	 */
	private ImageView readManagerInfo = null;

	/**
	 * 写入序列号图标
	 */
	private ImageView writeSerialNum = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initUI();
		/* 增加背景 */
		mLayout = (LinearLayout) this.findViewById(R.id.manager_info_layout);
		Utils.setBackgroud(mContext, mLayout);
	 ...
	 */
	public void initUI() {
		managerInfo = (EditText) this.findViewById(R.id.manager_info);
		managerInfo2 = (EditText) this.findViewById(R.id.manager_info2);
		managerInfo3 = (EditText) this.findViewById(R.id.manager_info3);
		managerInfo4 = (EditText) this.findViewById(R.id.manager_info4);
		managerInfo5 = (EditText) this.findViewById(R.id.manager_info5);
		managerInfo6 = (EditText) this.findViewById(R.id.manager_info6);
		managerInfo7 = (EditText) this.findViewById(R.id.manager_info7);
		managerInfo8 = (EditText) this.findViewById(R.id.manager_info8);
		managerInfo9 = (EditText) this.findViewById(R.id.manager_info9);
		managerInfo10 = (EditText) this.findViewById(R.id.manager_info10);
		managerInfo11 = (EditText) this.findViewById(R.id.manager_info11);
		managerInfo12 = (EditText) this.findViewById(R.id.manager_info12);
		managerInfo13 = (EditText) this.findViewById(R.id.manager_info13);
		managerInfo14 = (EditText) this.findViewById(R.id.manager_info14);
		managerInfo15 = (EditText) this.findViewById(R.id.manager_info15);
		managerInfo16 = (EditText) this.findViewById(R.id.manager_info16);
		managerInfo17 = (EditText) this.findViewById(R.id.manager_info17);
		managerInfo18 = (EditText) this.findViewById(R.id.manager_info18);
		managerInfo19 = (EditText) this.findViewById(R.id.manager_info19);
		managerInfo20 = (EditText) this.findViewById(R.id.manager_info20);
		managerInfo21 = (EditText) this.findViewById(R.id.manager_info21);
		managerInfo22 = (EditText) this.findViewById(R.id.manager_info22);
		managerInfo23 = (EditText) this.findViewById(R.id.manager_info23);
		managerInfo24 = (EditText) this.findViewById(R.id.manager_info24);
		managerInfo25 = (EditText) this.findViewById(R.id.manager_info25);
		managerInfo26 = (EditText) this.findViewById(R.id.manager_info26);
		managerInfo27 = (EditText) this.findViewById(R.id.manager_info27);
		managerInfo28 = (EditText) this.findViewById(R.id.manager_info28);
		managerInfo29 = (EditText) this.findViewById(R.id.manager_info29);
		managerInfo30 = (EditText) this.findViewById(R.id.manager_info30);
		managerInfo31 = (EditText) this.findViewById(R.id.manager_info31);
		managerInfo32 = (EditText) this.findViewById(R.id.manager_info32);
		setManagerInfo = (ImageView) this.findViewById(R.id.manager_set_manage_btn);
		readManagerInfo = (ImageView) this.findViewById(R.id.manager_read_manage_btn);
		writeSerialNum = (ImageView) this.findViewById(R.id.write_serial_num);
		serialNum = (EditText) this.findViewById(R.id.serial_num);
		...
		sendButton=(Button)this.findViewById(R.id.send_broadcast_btn);
...
//							message+="*41";
//							//Log.i(TAG, ""+message);
//							String message1="$BDNAL,7,0,1,3,11614907E,4004521N,11617520E,4005617N,11620868E,4001294N*4C";
//							mBDMessageInfo.setMessage(message1.getBytes("GBK"));
...
//				builder.create().show();
		...
		cmdButton=(Button)this.findViewById(R.id.send_cmd_btn);
...
//							String message="$BDNAC,12,11634262E,4056782N,1,11634278E,4056782N,0,,*41";
//							Log.i(TAG, ""+message);
...
//				builder.create().show();
		...
		reportButton=(Button)this.findViewById(R.id.send_report_btn);
