...
import com.novsky.map.fragment.BDLocationReportFragmentNew;
...
import com.novsky.map.fragment.Local4GInfoFragment;
...
import com.novsky.map.fragment.SosSettingFragment;
...
//		setContentView(R.layout.activity_bdmanager_horizontal);
        ...
        fragments.put(4, new BDLocationReportFragmentNew());//3

        //fragments.put(5, new FriendsLocationFragment());//4友邻位置(友邻信息)
        fragments.put(5, new SosSettingFragment());
        ...
        //fragments.put(17 , new Local4GInfoFragment()); //4G卡信息
        ...
        fragments.put(11, new BDSoftwareFragment());//关于
...
//			   break;
            case 17:
                trx.hide(fragments.get(lastIndex));
                if (!fragments.get(17).isAdded()) {
                    trx.add(R.id.message_detail_container, fragments.get(17));
                }
                trx.show(fragments.get(17)).commit();
                lastIndex = 17;
                break;
            case 18:
                Intent mIntent = new Intent();
                mIntent.setClass(mContext , Send4GMsgLandScapeActivity.class);
                startActivity(mIntent);
                break;
            default:
                break;
