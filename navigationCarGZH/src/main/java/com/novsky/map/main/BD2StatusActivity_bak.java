 ...
 * @author steve
 */
public class BD2StatusActivity_bak extends Activity {

	/**
	 * 日志标识
	 */
	private String TAG = "BD2StatusActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if("AOSP on wing".equals(Utils.DEVICE_MODEL)){
			setContentView(R.layout.activity_bd2_status_car_7);	
			dwR=175;
			iCenterX=235;
			iCenterY=180;
		}else{
			setContentView(R.layout.activity_bd2_status);	
		}
		...
		locationStatus=(TextView)this.findViewById(R.id.bd_location_status);
		if(locationModel==LocationStrategy.BD_ONLY_STRATEGY||locationModel==LocationStrategy.HYBRID_STRATEGY){
		...
		mBD2LinearLayout=(LinearLayout)this.findViewById(R.id.bd2_status_linearlayout);
		mBD2LinearLayout.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View arg0) {
				BD2StatusActivity_bak.this.finish();
			}
		});
	}
